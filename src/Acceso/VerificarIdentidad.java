...
/**
 * Formulario base para la pantalla Verificar identidad.
 *
 * @author mavel
 */
public class VerificarIdentidad extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VerificarIdentidad.class.getName());

    /**
     * Creates new form VerificarIdentidad
     */
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Verificar identidad");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VerificarIdentidad().setVisible(true));
    }
