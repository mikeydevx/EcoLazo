...
/**
 * Formulario base para la pantalla Cambiar contrasena.
 *
 * @author mavel
 */
public class CambiarContrasena extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CambiarContrasena.class.getName());
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Cambiar contrasena");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new CambiarContrasena().setVisible(true));
    }
