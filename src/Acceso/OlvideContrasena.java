...
/**
 * Formulario base para la pantalla Olvide mi contrasena.
 *
 * @author mavel
 */
public class OlvideContrasena extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(OlvideContrasena.class.getName());

    /**
     * Creates new form OlvideContrasena
     */
    ...
    private void initComponents() {
        ...
        setTitle("Olvide mi contrasena");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblTitulo.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTitulo.setText("Olvide mi contrasena");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new OlvideContrasena().setVisible(true));
    }
