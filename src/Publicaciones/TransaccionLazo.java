...
/**
 * Formulario base para la pantalla Transaccion Lazo.
 *
 * @author mavel
 */
public class TransaccionLazo extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TransaccionLazo.class.getName());

    /**
     * Creates new form TransaccionLazo
     */
    ...
    private void initComponents() {
        ...
        setTitle("Transaccion Lazo");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblTitulo.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTitulo.setText("Transaccion Lazo");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new TransaccionLazo().setVisible(true));
    }
