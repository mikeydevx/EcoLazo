...
/**
 * Formulario base para la pantalla Editar articulo.
 *
 * @author mavel
 */
public class EditarArticulo extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EditarArticulo.class.getName());
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Editar articulo");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new EditarArticulo().setVisible(true));
    }
