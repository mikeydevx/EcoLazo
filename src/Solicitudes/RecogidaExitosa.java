...
/**
 * Formulario base para la pantalla Recogida exitosa.
 *
 * @author mavel
 */
public class RecogidaExitosa extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(RecogidaExitosa.class.getName());

    /**
     * Creates new form RecogidaExitosa
     */
    public RecogidaExitosa() {
        initComponents();
        setSize(320, 620);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        setTitle("Recogida exitosa");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblTitulo.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTitulo.setText("Recogida exitosa");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new RecogidaExitosa().setVisible(true));
    }
