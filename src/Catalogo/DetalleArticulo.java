...
/**
 * Formulario base para la pantalla Detalle articulo.
 *
 * @author mavel
 */
public class DetalleArticulo extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DetalleArticulo.class.getName());
    ...
    private void initComponents() {
        ...
        setTitle("Detalle articulo");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblTitulo.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        lblTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTitulo.setText("Detalle articulo");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DetalleArticulo().setVisible(true));
    }
